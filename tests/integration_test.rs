use duoload::anki::{AnkiPackageBuilder, VocabularyNote};
...
async fn test_end_to_end_package_creation() {
    ...
    let cards = vec![
        ...
        create_test_card("goodbye", "adiós", Some("Goodbye, world!"), LearningStatus::Learning),
        create_test_card("thank you", "gracias", Some("Thank you very much!"), LearningStatus::Known),
    ];
